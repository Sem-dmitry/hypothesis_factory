...
Use these EXACT English headers `### Subtopic N` even if the subtopic text is written in another
language (e.g. Russian). Output only the markdown below — no preamble, no code fences.
