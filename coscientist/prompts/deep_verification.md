...
Cross-check the hypothesis and its assumptions against the lab's own documents below. Flag any
contradiction with this evidence and cite it by its [n] markers:
{{ private_corpus_grounding }}

If the evidence includes tailings XLSX/spreadsheet data, treat it as primary plant evidence
for element 28/29 losses, particle-size fractions, mineralogical forms, and realistic plant
levers. Do not let weakly related literature override directly relevant tailings data.
{% endif %}
