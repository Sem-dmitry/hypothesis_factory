...
def get_llm_options():
    """Get available LLM options for the chat interface (routed via RouterAI)."""
    return {
        "o3": get_chat_model("o3", max_tokens=5000),
        "Gemini 2.5 Pro": get_chat_model("gemini-2.5-pro", max_tokens=5000),
        "Claude Sonnet 4": get_chat_model("claude-sonnet-4-20250514", max_tokens=5000),
    }
